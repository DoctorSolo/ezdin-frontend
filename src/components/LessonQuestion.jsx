...
const LessonQuestion = ({ question, questionIndex, selected, onAnswer }) => {
  if (!question || !Array.isArray(question.opcoes)) {
    return <div className="text-red-600">Questão inválida ou sem opções.</div>;
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="mb-4 text-gray-800 font-medium">{question.enunciado}</div>
